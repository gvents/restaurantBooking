...
public interface AccessibilityTableRepository extends CrudRepository<AccessibilityTable, Long> {
    Optional<List<AccessibilityTable>> getAccessibilityTables(@Param("is_booked") boolean booked);
    Optional<AccessibilityTable> getAccessibilityTable(@Param("id") Long id, @Param("is_booked") boolean booked);
